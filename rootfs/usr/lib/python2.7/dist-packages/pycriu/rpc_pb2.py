...
_CRIU_OPTS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='status_fd', full_name='criu_opts.status_fd', index=46,
